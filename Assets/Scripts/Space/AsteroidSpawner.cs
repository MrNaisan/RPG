...
public class AsteroidSpawner : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        {
            float posX = Random.Range(0, 2) == 0 ? Random.Range(3, AsteroidsCount) : Random.Range(-1 * AsteroidsCount, -3);
            float posY = Random.Range(0, 2) == 0 ? Random.Range(3, AsteroidsCount / 5) : Random.Range(-1 * AsteroidsCount / 5, -3);
            float posZ = Random.Range(0, 2) == 0 ? Random.Range(3, AsteroidsCount) : Random.Range(-1 * AsteroidsCount, -3);
